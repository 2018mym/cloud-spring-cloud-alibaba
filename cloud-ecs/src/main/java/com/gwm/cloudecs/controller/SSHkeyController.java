...
public class SSHkeyController {
     ...
     */
    @GetMapping("/get/list")
    public Object sshkeyList(HttpServletRequest request,KeyPairsListDTO keyPairsListDTO) {
     ...
     */
    @GetMapping("/get/info")
    public Object sshkeyInfo(HttpServletRequest request,KeyPairs keyPairs) {
        String groupId = request.getParameter("groupId");
        String userId = request.getParameter("userId");
    ...
    public Object createSshkeyInfo(@RequestHeader("ticket") String ticket,HttpServletRequest request,@RequestBody KeyPairs keyPairs) {
        String groupId = request.getParameter("groupId");
        String userId = request.getParameter("userId");
        keyPairs.setProjectId(groupId);
        keyPairs.setUserId(userId);
