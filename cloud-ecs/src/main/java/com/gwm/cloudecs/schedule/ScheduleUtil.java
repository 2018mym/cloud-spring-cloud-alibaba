...
public class ScheduleUtil {
    ...
    public interface ECSRunnable extends Runnable {
        String getName();
    }
     ...
     */
    public static void stard(ECSRunnable sr, long delay, long period, TimeUnit unit) {
     ...
     * @return
     */
    public static boolean isAlive(ECSRunnable sr) {
...
//            //1、待执行的线程类
//            int finalI = i;
//            ECSRunnable sr = new ECSRunnable() {
