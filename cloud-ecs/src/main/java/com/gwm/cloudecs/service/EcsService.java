...
public interface EcsService {
     ...
     * @return
     */
    ResponseResult createInstances(InstancesDTO instancesDTO, String userId, String groupId) throws IOException;
     ...
     * @return
     */
    ResponseResult instanceAttachVolume(AttachVolumeDTO attachVolumeDTO) throws IOException;
     ...
     * @return
     */
    ResponseResult instanceRebuild(InstancesDTO instancesDTO, String userId, String groupId);
